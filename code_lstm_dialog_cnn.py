...
from data_helper_cnn import data_helper
...
U, U_dev, U_tst, Q, Q_dev, Q_tst, labels, labels_dev, labels_tst, label2id, word_class = data_helper('trn_cnn.json', 'dev_cnn.json', 'tst_cnn.json')
#label的个数
